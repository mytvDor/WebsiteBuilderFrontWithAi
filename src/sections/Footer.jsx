          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-zinc-400 mb-6">
                The ultimate static website builder combining templates and AI
                for effortless website creation.
              </p>
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="p-2 bg-zinc-200 rounded-full hover:bg-lime-400 transition"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
